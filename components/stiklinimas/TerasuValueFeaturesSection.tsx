...
const FEATURES = [
  {
    title: "Šiltos arba šaltos sistemos",
    description: "Sprendimas parenkamas pagal naudojimo sezoną, komforto poreikį ir planuojamą biudžetą.",
  },
  {
    title: "Stumdomos durys ir dalių kiekis",
    description: "Pritaikomas durų ir stumdomų dalių skaičius pagal terasos dydį bei kasdienio naudojimo patogumą.",
  },
  {
    title: "Stiklo ir konstrukcijos tipas",
    description: "Parenkami skirtingi stiklo sprendimai ir konstrukcijos tipai pagal architektūrą bei poreikį.",
  },
  {
    title: "Individualus dizaino pritaikymas",
    description: "Sistema derinama prie modernaus arba klasikinio namo stiliaus, išlaikant estetiką ir funkcionalumą.",
  },
] as const;
...
export function TerasuValueFeaturesSection() {
  return (
      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 md:px-[70px]">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-10 xl:gap-14">
          <div className="relative min-h-[360px] overflow-hidden rounded-2xl bg-[#e8ebfa] lg:min-h-[840px]">
            <ParallaxCoverImage
              alt="Terasų stiklinimo konstrukcija"
              fill
              priority={false}
              sizes="(max-width: 1023px) 100vw, 46vw"
              src="/images/Terasu stiklinimas/ChatGPT Image May 7, 2026, 03_46_07 PM (1).png"
            />
          </div>
          ...
          <div className="flex max-w-[560px] flex-col gap-12 lg:gap-16 xl:gap-20">
            <div>
              <h2 className="text-3xl font-semibold leading-[1.12] tracking-[-0.03em] text-[#16216b] md:text-[45px] md:leading-[52px]">
                <span className="text-[#263cd0]">Stumdomos durys, konstrukcijos tipas </span>
                <span className="text-[#16216b]">ir individualūs sprendimai</span>
              </h2>
            </div>
