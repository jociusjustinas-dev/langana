...
const TABS: readonly TerasuTab[] = [
  {
    id: "siltos",
    shortLabel: "Šiltos sistemos",
    title: "Šiltos terasų stiklinimo sistemos",
    description:
      "Sprendimas, kai norite terasa naudotis didesnę metų dalį ir pagerinti šilumos, sandarumo bei komforto lygį.",
    bullets: [
      "Geresnė šilumos izoliacija",
      "Daugiau komforto vėsesniu sezonu",
      "Padeda sumažinti šilumos nuostolius",
      "Tinka jaukiai poilsio erdvei",
      "Gera garso izoliacija",
      "Ilgaamžis sprendimas",
    ],
    imageSrc: "/images/alium4.png",
    imageAlt: "Šiltos terasų stiklinimo sistemos",
  },
  {
    id: "saltos",
    shortLabel: "Šaltos sistemos",
    title: "Šaltos sistemos",
    description:
      "Praktiškas sprendimas, kai norite apsaugoti terasą nuo lietaus, vėjo, sniego, dulkių ir ilgiau išlaikyti ją švarią bei patogią naudoti.",
    bullets: [
      "Apsauga nuo vėjo ir lietaus",
      "Lengvesnė konstrukcija",
      "Patogu naudoti šiltuoju sezonu",
      "Galima atverti stumdomas dalis",
      "Mažiau priežiūros terasos viduje",
      "Tinka skirtingiems namų stiliams",
    ],
    imageSrc: "/images/alium2.png",
    imageAlt: "Šaltos terasų stiklinimo sistemos",
  },
] as const;
...
export function TerasuStiklinimasSystemTabs() {
