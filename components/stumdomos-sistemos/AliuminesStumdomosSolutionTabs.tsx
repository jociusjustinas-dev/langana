...
export function AliuminesStumdomosSolutionTabs({ products }: { products: readonly ProductCardProps[] }) {
  ...
  return (
    <div className="mx-auto mt-8 max-w-[1440px] px-4 md:mt-10 md:px-[70px]">
      <div className="mb-8 md:mb-12">
        <SegmentedPillTabList ariaLabel="Aliuminių stumdomų sistemų tipai">
          {products.map((tab, i) => {
