...
const TABS: readonly SolutionTab[] = [
  {
    id: "namams",
    shortLabel: "Namams",
    title: "Metalinės lauko durys namams",
    description:
      "Patikimas pasirinkimas individualiems namams, kai svarbiausia saugumas, ilgaamžiškumas ir racionali investicija.",
    bullets: [
      "Tvirta konstrukcija",
      "Apsauga nuo įsilaužimo",
      "Ilgaamžis sprendimas",
      "Geras kainos ir kokybės santykis",
      "Dvigubų spynų galimybė",
      "Platus dizaino pasirinkimas",
    ],
    imageSrc: "/images/Durys/ChatGPT Image May 7, 2026, 03_18_08 PM (4).png",
    imageAlt: "Metalinės lauko durys namams",
    objectPosition: "40% 48%",
  },
  {
    id: "butams",
    shortLabel: "Butams / daugiabučiams",
    title: "Metalinės durys butams ir daugiabučiams",
    description:
      "Sprendimas butams ir bendroms daugiabučių erdvėms, kai svarbu saugumas, garso izoliacija ir patikimas kasdienis naudojimas.",
    bullets: [
      "Geresnis saugumo jausmas",
      "Padeda sumažinti garsus iš laiptinės",
      "Tinka intensyviam naudojimui",
      "Galimi skirtingi apdailos sprendimai",
      "Patikimos spynos",
      "Lengva priežiūra",
    ],
    imageSrc: "/images/Durys/ChatGPT Image May 7, 2026, 03_18_07 PM (2).png",
    imageAlt: "Metalinės durys daugiabučiui",
    objectPosition: "52% 45%",
  },
  {
    id: "techninems",
    shortLabel: "Techninėms patalpoms",
    title: "Metalinės durys techninėms ir pagalbinėms patalpoms",
    description:
      "Praktiškas sprendimas sandėliams, garažams, ūkinėms ar kitoms pagalbinėms patalpoms, kur svarbus tvirtumas ir funkcionalumas.",
    bullets: [
      "Tinka pagalbinėms patalpoms",
      "Atspari konstrukcija",
      "Racionali kaina",
      "Ilgas tarnavimo laikas",
      "Paprastas naudojimas",
      "Galimas pristatymas ir montavimas",
    ],
    imageSrc: "/images/Durys/ChatGPT Image May 7, 2026, 03_18_39 PM (3).png",
    imageAlt: "Metalinės durys techninėms patalpoms",
...
export function MetalinesDurysSolutionTabs({ sectionId = "sprendimai-metalines" }: { sectionId?: string }) {
      ...
      <div className="mx-auto max-w-[1440px]">
        ...
        >
          ...
          <div className="mx-auto mt-10 flex w-full min-w-0 flex-col">
            <SegmentedPillTabList ariaLabel="Metalinių durų sprendimų tipai" className="mb-8 md:mb-12">
              {TABS.map((tab, i) => {
