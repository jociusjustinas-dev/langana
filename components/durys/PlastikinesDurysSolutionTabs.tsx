...
const TABS: readonly SolutionTab[] = [
  {
    id: "lauko",
    shortLabel: "Lauko durys",
    title: "Plastikinės lauko durys",
    description:
      "Tvirtas ir ekonomiškas pasirinkimas individualiam namui, kai svarbu šiluma, sandarumas, dizainas ir atsparumas oro sąlygoms.",
    bullets: [
      "Tinka nuosaviems namams",
      "Atsparios klimato poveikiui",
      "Galima derinti prie fasado",
      "Gera kainos ir kokybės pusiausvyra",
      "Lengva priežiūra",
      "Galimos skirtingos spalvos",
    ],
    imageAlt: "Plastikinės lauko durys — vizualizacija",
    objectPosition: "28% 42%",
  },
  {
    id: "balkonas-terasa",
    shortLabel: "Balkonas / terasa",
    title: "Plastikinės balkono ir terasos durys",
    description:
      "Patogus sprendimas išėjimui į balkoną ar terasą, kai norisi daugiau šviesos, sandarumo ir kasdienio naudojimo patogumo.",
    bullets: [
      "Tinka balkonams ir terasoms",
      "Gali atsidaryti į vidų arba į išorę",
      "Galima rinktis 2 arba 3 stiklų paketą",
      "Sandari konstrukcija",
      "Lengva valyti",
      "Derinama su langais",
    ],
    imageAlt: "Plastikinės balkono ir terasos durys — vizualizacija",
    objectPosition: "52% 45%",
  },
  {
    id: "komercines",
    shortLabel: "Komercinės erdvės",
    title: "Plastikinės durys komercinėms erdvėms",
    description:
      "Praktiškas sprendimas parduotuvėms, biurams ir kitoms patalpoms, kuriose reikalingos lengvai prižiūrimos ir funkcionalios durys.",
    bullets: [
      "Tinka biurams ir parduotuvėms",
      "Atsparios kasdieniam naudojimui",
      "Galima pritaikyti spalvą",
      "Patogus naudojimas",
      "Lengva priežiūra",
      "Racionali investicija",
    ],
    imageAlt: "Plastikinės durys komercinėms patalpoms — vizualizacija",
...
export function PlastikinesDurysSolutionTabs({ sectionId = "sprendimai-plastikines" }: { sectionId?: string }) {
      ...
      <div className="mx-auto max-w-[1440px]">
        ...
        >
          ...
          <div className="mx-auto mt-10 flex w-full min-w-0 flex-col">
            <SegmentedPillTabList ariaLabel="Plastikinių durų sprendimų tipai" className="mb-8 md:mb-12">
              {TABS.map((tab, i) => {
